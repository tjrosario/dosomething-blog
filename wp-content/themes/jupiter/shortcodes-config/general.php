...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "colorpicker",
            "heading" => __("Overlay Color Mask", "mk_framework"),
            "param_name" => "video_color_mask",
            "value" => "",
            "description" => __("Creates an overlay layer on your video background.", "mk_framework"),
            "dependency" => array(
                'element' => "layout_structure",
                'value' => array(
                    'full'
        ...
        array(
            ...
            'param_name' => 'sidebar',
            'description' => __( 'Please select the sidebar you would like to show in this page section.', 'js_composer' ),
            "dependency" => array(
                'element' => "layout_structure",
                'value' => array(
                    'full'
...
vc_map(array(
    ...
    "as_parent" => array('except' => 'mk_page_section'),
    "content_element" => true,
    "show_settings_on_create" => true,
...
vc_map(array(
    ...
    'description' => __( 'Content Box with heading', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
...
vc_map(array(
    ...
    'description' => __( 'Adds a circled image element.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Heading Title", "mk_framework"),
...
vc_map(array(
    ...
    'description' => __( 'Small callout box for important infos.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Title", "mk_framework"),
...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "colorpicker",
            "heading" => __("Skill Title Color", "mk_framework"),
            "param_name" => "txt_color",
            "value" => '',
            "description" => __("", "mk_framework")
        ),
        array(
            "type" => "colorpicker",
            "heading" => __("Skill Indicator Bar Background Color", "mk_framework"),
            "param_name" => "color",
            "value" => $skin_color,
            "description" => __("", "mk_framework")
        ),
        array(
            "type" => "colorpicker",
            "heading" => __("Skill Bar Background Color", "mk_framework"),
        ...
        array(
            "type" => "colorpicker",
            "heading" => __("Skill Percent Color", "mk_framework"),
...
vc_map(array(
    ...
    'description' => __( 'Show skills & data in diagram charts.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Heading Title", "mk_framework"),
...
vc_map(array(
    ...
    'description' => __( 'News feed in tabs style.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
...
vc_map(array(
    ...
    'description' => __( 'Place Widgetized sidebar', 'js_composer' ),
    ...
    "params" => array(
        array(
          ...
          'heading' => __( 'Sidebar', 'js_composer' ),
          'param_name' => 'sidebar',
          'description' => __( 'Select the widget area to be shown in this sidebar.', 'js_composer' )
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "mk_framework"),
...
vc_map(array(
    ...
    "category" => __('General', 'mk_framework'),
    'description' => __( 'Output raw HTML code in your page', 'js_composer' ),
    "wrapper_class" => "clearfix",
    "params" => array(
        array(
...
vc_map(array(
    ...
    "category" => __('General', 'mk_framework'),
    'description' => __( 'Output raw javascript code in your page', 'js_composer' ),
    "wrapper_class" => "clearfix",
    "params" => array(
        array(
            "type" => "textarea_raw_html",
...
vc_map(array(
    ...
    "category" => __('General', 'mk_framework'),
    'description' => __( 'Tab based slider.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "multiselect",
