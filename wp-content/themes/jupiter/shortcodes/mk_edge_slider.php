...
$button2_txt_color = $button1_txt_color = $outline1_hover_color = $outline2_hover_color = $button2_bg_color = $button1_bg_color = $outline2_active_color = $video_color_mask_css = $outline1_active_color = $pagination_class = $content_opacity = '';
...
$output .= '<div id="mk-edge-slider-'.$id.'" class="mk-edge-slider swiper-container first-el-' . $first_el . '"  data-height="'.$height.'" data-first="' . $first_el . '" data-fullHeight="'.$full_height.'" data-pause="'.$slideshow_speed.'" data-speed="'.$animation_speed.'" data-pagination="'.$pagination_class.'">';
...
$output .= '<div class="swiper-slide '.$caption_align.$cover_bg.'" data-header-skin="' . $header_skin . '" '.$bg_image_css.'>';
...
if ( !empty($direction_nav) && $direction_nav != 'none') {
	...
	$output .= '	<a class="mk-edge-prev" data-skin="' . $header_skin . '">';
	...
	$output .= '<span class="mk-edge-nav nav-'.$direction_nav.'">';
	$output .= '	<a class="mk-edge-next" data-skin="' . $header_skin . '">';
