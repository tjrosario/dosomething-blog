			...
			<div class="article-wrapper">
							<time class="mk-post-date" datetime="<?php the_date() ?>">
 							...
 							<div class="row">
								...
								<div class="single-social-section top">
							...
							<div class="blog-single-meta">
								<div class="mk-blog-author"><?php _e('by', 'mk_framework'); ?> <?php the_author_posts_link(); ?></div>
									<div class="mk-post-cat"> <?php _e('Listed in', 'mk_framework'); ?> <?php the_category( ', ' ) ?></div>
							</div>
							<?php endif; ?>
							...
							<div class="single-post-tags">
								...
								<div class="single-social-section bottom">
									<h3 class="single-social-title">Share This Article</h3>
									<div class="mk-love-holder"><?php echo mk_love_this(); ?></div>
									<?php
									if($mk_options['enable_blog_single_comments'] == 'true') :
											if ( get_post_meta( $post->ID, '_disable_comments', true ) != 'false' ) {
						...
						<div class="mk-about-author-wrapper">
								...
								<ul class="about-author-social">
									...
									if(get_the_author_meta( 'twitter' )) {
										/*
										echo '<li class="twitter"><a class="twitter-icon" title="'.__('Follow me on Twitter','mk_framework').'" href="'.get_the_author_meta( 'twitter' ).'"><i class="mk-moon-twitter"></i></a></li>';
										*/
										echo '<li class="twitter">Follow Me: <a class="twitter-icon" title="'.__('Follow me on Twitter','mk_framework').'" href="'.get_the_author_meta( 'twitter' ).'">'.str_replace('https://twitter.com/', '@', get_the_author_meta( 'twitter' )).'</a></li>';
									}
									if(get_the_author_meta('email')) {
										/*
										echo '<li class="email"><a class="email-icon" title="'.__('Get in touch with me via email','mk_framework').'" href="mailto:'.get_the_author_meta('email').'"><i class="mk-moon-envelop"></i></a></li>';
										*/
										echo '<li class="email">Email me: <a class="email-icon" title="'.__('Get in touch with me via email','mk_framework').'" href="mailto:'.get_the_author_meta('email').'">'.get_the_author_meta('email').'</a></li>';
									}
									?>
								</ul>
								</div>
