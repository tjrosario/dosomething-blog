        ...
        while ($r->have_posts()):
            $r->the_post();
                    ...
                    if (has_post_thumbnail()) {
                        ...
                        $output .= '<img alt="' . get_the_title() . '" class="item-featured-image"  title="' . get_the_title() . '" src="' . $image_src . '" itemprop="image" />';
                        ...
                        $output .= '</div>';
                            ...
                            $output .= '<div class="teaser-comment-love-wrapper">';
                                    ob_start();
                                    comments_number('0', '1', '%');
                                    $output .= '<a href="' . get_permalink() . '#comments" class="blog-teaser-comment"><i class="mk-moon-bubble-9"></i><span>' . ob_get_contents() . '</span></a>';
                                    ob_get_clean();
