...
if ($sortable == 'true' && !is_archive()) {
     $output .= '<header class="sortable-'.$sortable_style.'-style portfolio-fiter-' . $style . ' sortable-id-' . $id . '" id="mk-filter-portfolio"'.$sortable_margin.'><div class="mk-grid"><ul>';
     $terms = array();
     if ($cat != '') {
     ...
     foreach ($terms as $term) {
          ...
          if (defined("ICL_LANGUAGE_CODE")) { 
               $output .= '<li><a data-filter=".' . $term->slug . '" href="#">' . str_replace('@'.ICL_LANGUAGE_CODE, '', $term->name) . '</a></li>';
          } else {
