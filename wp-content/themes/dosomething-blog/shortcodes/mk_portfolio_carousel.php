...
$output .= '<li>';
$output .= '<div class="mk-portfolio-carousel-thumb"><img width="260" height="180" src="'.$image_src.'" alt="'.get_the_title().'" title="'.get_the_title().'" />';
...
$output .= '<a class="portfolio-carousel-title" href="'.$permalink.'">'.get_the_title().'</a>';
...
$output .= '<div class="featured-image"><img width="500" height="350" src="'.$image_src.'" alt="'.get_the_title().'" title="'.get_the_title().'"  class="item-featured-image" />';
