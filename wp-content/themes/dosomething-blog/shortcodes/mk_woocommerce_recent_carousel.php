			...
			while($r->have_posts()): $r->the_post();
				$output .= '<div class="swiper-slide">';
					...
					$image_src_array = wp_get_attachment_image_src(get_post_thumbnail_id(), 'full', true);
							...
							$output .= '<i class="mk-jupiter-icon-plus-circle"></i>';
