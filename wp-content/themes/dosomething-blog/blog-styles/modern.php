...
function blog_modern_style($atts, $current)
{
    ...
    $output .= '<time class="mk-post-date" datetime="' . get_the_date() . '">';
    ...
    $output .= '<div class="row"><div class="view"><a class="blog-modern-btn" href="' . get_permalink() . '">' . __('Read More', 'mk_framework') . '</a></div>';
    $output .= '';
