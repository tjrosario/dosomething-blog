            ...
            if ($related->have_posts())
                ...
                while ($related->have_posts())
                    ...
                    if (has_post_thumbnail())
                        ...
                        $output .= '<div class="portfolio-similar-posts-image"><img src="' . $image_src . '" alt="' . get_the_title() . '" title="' . get_the_title() . '" />';
                        ...
                        $output .= '<a class="the-title" href="' . get_permalink() . '">' . get_the_title() . '</a>';
