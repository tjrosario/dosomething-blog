...
$theme_options_typography = array(
    ...
    array(
        ...
        "desc" => __("Please add your desired character sets hers as a comma separated list. This option is going to work if you choose Google Fonts and need to have glyphs other than English.
Such as: latin,latin-ext,cyrillic-ext,greek-ext,greek,vietnamese,cyrillic"),
    ...
    array(
        "name" => __("Google Font character sets", "mk_framework"),
        "desc" => __("Please add your desired character sets hers as a comma separated list. This option is going to work if you choose Google Fonts and need to have glyphs other than English.
Such as: latin,latin-ext,cyrillic-ext,greek-ext,greek,vietnamese,cyrillic", "mk_framework"),
