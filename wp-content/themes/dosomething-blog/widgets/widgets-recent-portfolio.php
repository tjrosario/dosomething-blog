...
class Artbees_Widget_Recent_Portfolio extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        <?php	$image_src_array = wp_get_attachment_image_src( get_post_thumbnail_id(), 'full', true );	
		 ...
		 <a class="mk-lightbox portfolio-widget-lightbox" title="<?php the_title(); ?>" data-fancybox-group="blog-widget-recent-portfolio" href="<?php echo $image_src_array[0]; ?>"><i class="mk-icon-zoom-in"></i></a>
